// Configurações e constantes da Bíblia
const BIBLE_BOOKS = {
  // Antigo Testamento
...
// Agrupamento por testamento
const TESTAMENT_GROUPS = {
  'Antigo Testamento': Object.keys(BIBLE_BOOKS).slice(0, 39),
  'Novo Testamento': Object.keys(BIBLE_BOOKS).slice(39)
};

// Configurações do app
const APP_CONFIG = {
  version: '2.0.0',
  cacheName: 'biblia-arc-v2',
  maxHistoryItems: 100,
  averageVersesPerChapter: 25,
  toastDuration: 2500
};